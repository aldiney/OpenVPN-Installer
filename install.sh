...
for module in core log ui config os_detect deps pki wizard_ipproto server_config ccd client_profile mikrotik_profile firewall gateway frr route_reconcile route_sync link hub_sync dualhub lifecycle upgrade syscmd controller; do
