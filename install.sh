...
for module in core log ui os_detect deps pki wizard_ipproto server_config ccd client_profile mikrotik_profile gateway firewall hub_sync dualhub lifecycle controller; do
